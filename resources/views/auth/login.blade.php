...
<head>
    ...
    <title>Login - Premium Laundry</title>
    ...
    <div class="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
        ...
        <div class="relative hidden lg:flex flex-col justify-end overflow-hidden rounded-2xl m-3">
            ...
            <div class="relative z-10 p-8 pb-10">
                ...
                <h2 class="text-3xl font-bold text-white leading-tight mb-1">Bersih, Wangi &</h2>
                <h2 class="text-3xl font-bold text-secondary-100 leading-tight mb-4">Tepat Waktu.</h2>
                <p class="text-sm text-white/70 leading-relaxed max-w-xs">Serahkan cucianmu pada kami. Nikmati layanan laundry premium dengan harga terjangkau dan hasil yang selalu memuaskan.</p>
            </div>
        </div>

        <div class="flex flex-col justify-center px-8 sm:px-12 lg:px-14 py-12">
            <div class="w-full max-w-sm mx-auto">
                <h1 class="text-3xl font-bold text-gray-800 mb-8">Masuk ke Akun Anda</h1>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="checkbox" id="remember" name="remember" class="w-4 h-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500 cursor-pointer">
                ...
                <div class="mt-6 bg-brand-50 border border-brand-100 rounded-xl p-4">
                    <p class="text-sm font-semibold text-brand-800 mb-1">🎉 Promo Spesial</p>
                    <p class="text-xs text-brand-700/70 leading-relaxed">Daftar sekarang dan dapatkan diskon 20% untuk order pertamamu! Berlaku untuk semua jenis layanan.</p>
                </div>

                <p class="mt-6 text-center text-sm text-gray-500">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="font-semibold text-secondary-500 hover:text-secondary-600 transition-colors">Daftar sekarang</a>
                </p>
            </div>
        </div>
